...
@Component({
    templateUrl: './asamblea-general-ordinaria-accionistas.component.html',
    styleUrls: ['./asamblea-general-ordinaria-accionistas.component.scss'],
    selector: 'app-asamblea-general-ordinaria-accionistas',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [UncommentHtmlPipe]
})
export class AsambleaGeneralOrdinariaAccionistasComponent implements OnInit, OnDestroy {
