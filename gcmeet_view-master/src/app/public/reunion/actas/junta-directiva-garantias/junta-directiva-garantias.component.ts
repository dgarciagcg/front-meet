...
@Component({
    templateUrl: './junta-directiva-garantias.component.html',
    styleUrls: ['./junta-directiva-garantias.component.scss'],
    selector: 'app-junta-directiva-garantias',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [UncommentHtmlPipe]
})
export class JuntaDirectivaGarantiasComponent implements OnInit, OnDestroy {
