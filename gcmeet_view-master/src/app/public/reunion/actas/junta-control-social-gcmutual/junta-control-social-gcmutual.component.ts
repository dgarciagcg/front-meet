...
@Component({
    templateUrl: './junta-control-social-gcmutual.component.html',
    styleUrls: ['./junta-control-social-gcmutual.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    selector: 'app-junta-control-social-gcmutual',
    providers: [UncommentHtmlPipe]
})
export class JuntaControlSocialGcmutualComponent implements OnInit, OnDestroy {
